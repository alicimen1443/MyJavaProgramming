...
public class BuildInFunctionalInterfaces2 {
    public static void main(String[] args) {
        ...
        //When it comes to take 2 parameters and returns value as a boolean, then we should use BiPredicate functional interface
        ...
        Integer[] arr = {1, 2, 3, 4, 56, 7, 8, 9, 10};
        ...
        //BiConsumer functional interface takes 2 arguments and returns no value(void)
        ...
        BiConsumer<String,String> formattedFullName=(a,b)->{
        ...
        formattedFullName.accept("ali","cimen");
        ...
        //another way of iterating the map by using forEach() method of lambda expression
        scrumTeam1.forEach((k,v)-> System.out.println(k+" : "+v));

        System.out.println("------------------------------------------------------------");

        //1-Create a function that takes two integers and returns the maximum integer
        //Whenever you want a create a method that takes 2 arguments and returns a values then you should
        //go with BiFunction functional interface

        BiFunction<Integer,Integer,Integer> maxNum = (a,b)->{return (a>b)?a:b;};
