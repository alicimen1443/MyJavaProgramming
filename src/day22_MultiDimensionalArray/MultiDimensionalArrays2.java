...
public class MultiDimensionalArrays2 {
    public static void main(String[] args) {
        ...
        //                          0                              1( for the 2 dimensional arrays)
        //                     0        1    2                0          1         2 (for the single dimensional arrays)
        //                   0 1 2   0 1 2   0 1 2        0 1 2      0 1 2     0 1 2  (for the elements)
