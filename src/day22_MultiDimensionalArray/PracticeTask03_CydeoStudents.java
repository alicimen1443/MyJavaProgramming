...
public class PracticeTask03_CydeoStudents {
    public static void main(String[] args) {

        String[] batch25Group1 = {"Jülide", "Ayhan", "Irene", "Yulia", "Muhtar"};
...
3. CydeoStudents Task:
		...
		3. given the following arrays:
 		...
 		4. declare an array variable named batch24Groups with the length of
 				4.1 Assign batch24Group1, batch24Group2, batch24Group3 to each indexes of the variable batch25Groups
