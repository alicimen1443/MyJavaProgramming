...
import day43_Exceptions.EmployeeTask.Developer;
import day43_Exceptions.EmployeeTask.Employee;
import day43_Exceptions.EmployeeTask.Tester;
...
public class PolymorphismPractice2 {
    public static void main(String[] args) {
        ...
        for (Developer eachDev : developers) {
            if(eachDev.getSalary()> devWithMaxSalary.getSalary()){
                devWithMaxSalary=eachDev;
            }
        }
