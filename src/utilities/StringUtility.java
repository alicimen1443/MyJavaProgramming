...
public class StringUtility {
    ...
    // prints each character of the giving string
    ...
    // checks if the given string is palindrome, returns boolean result
    ...
    //removes the duplicates from given string ,return String. "aaaabbbbbcccc"===>"abc"
